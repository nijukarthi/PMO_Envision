...
@Component({
  selector: 'app-project-o&m-generations',
  imports: [Shared],
  templateUrl: './project-oandm-generations.component.html',
  styleUrl: './project-oandm-generations.component.scss'
})
export class ProjectOandmGenerationsComponent {
