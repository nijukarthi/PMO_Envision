...
@Component({
  selector: 'app-project-iandc-commissioning',
  imports: [Shared],
  templateUrl: './project-iandc-commissioning.component.html',
  styleUrl: './project-iandc-commissioning.component.scss'
})
export class ProjectIandcCommissioningComponent {
