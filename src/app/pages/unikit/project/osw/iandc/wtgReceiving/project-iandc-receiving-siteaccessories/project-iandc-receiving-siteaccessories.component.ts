...
@Component({
  selector: 'app-project-iandc-receiving-siteaccessories',
  imports: [Shared],
  templateUrl: './project-iandc-receiving-siteaccessories.component.html',
  styleUrl: './project-iandc-receiving-siteaccessories.component.scss'
})
export class ProjectIandcReceivingSiteaccessoriesComponent {
