...
@Component({
  selector: 'app-project-iandc-receiving-nacelle',
  imports: [Shared],
  templateUrl: './project-iandc-receiving-nacelle.component.html',
  styleUrl: './project-iandc-receiving-nacelle.component.scss'
})
export class ProjectIandcReceivingNacelleComponent {
