...
@Component({
  selector: 'app-project-iandc-receiving-hub',
  imports: [Shared],
  templateUrl: './project-iandc-receiving-hub.component.html',
  styleUrl: './project-iandc-receiving-hub.component.scss'
})
export class ProjectIandcReceivingHubComponent {
