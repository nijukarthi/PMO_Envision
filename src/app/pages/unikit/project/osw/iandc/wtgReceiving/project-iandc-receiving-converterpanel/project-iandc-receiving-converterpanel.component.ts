...
@Component({
  selector: 'app-project-iandc-receiving-converterpanel',
  imports: [Shared],
  templateUrl: './project-iandc-receiving-converterpanel.component.html',
  styleUrl: './project-iandc-receiving-converterpanel.component.scss'
})
export class ProjectIandcReceivingConverterpanelComponent {
