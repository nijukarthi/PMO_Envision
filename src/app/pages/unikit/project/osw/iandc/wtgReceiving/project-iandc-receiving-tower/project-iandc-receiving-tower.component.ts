...
@Component({
  selector: 'app-project-iandc-receiving-tower',
  imports: [Shared],
  templateUrl: './project-iandc-receiving-tower.component.html',
  styleUrl: './project-iandc-receiving-tower.component.scss'
})
export class ProjectIandcReceivingTowerComponent {
