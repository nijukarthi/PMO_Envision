...
@Component({
  selector: 'app-project-iandc-receiving-blade',
  imports: [Shared],
  templateUrl: './project-iandc-receiving-blade.component.html',
  styleUrl: './project-iandc-receiving-blade.component.scss'
})
export class ProjectIandcReceivingBladeComponent {
