...
@Component({
  selector: 'app-project-iandc-receiving-anchorcage',
  imports: [Shared],
  templateUrl: './project-iandc-receiving-anchorcage.component.html',
  styleUrl: './project-iandc-receiving-anchorcage.component.scss'
})
export class ProjectIandcReceivingAnchorcageComponent {
