...
@Component({
  selector: 'app-project-iandc-hoto',
  imports: [Shared],
  templateUrl: './project-iandc-hoto.component.html',
  styleUrl: './project-iandc-hoto.component.scss'
})
export class ProjectIandcHotoComponent {
