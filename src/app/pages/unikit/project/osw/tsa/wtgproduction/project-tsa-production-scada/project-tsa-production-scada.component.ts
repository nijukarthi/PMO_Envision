...
@Component({
  selector: 'app-project-tsa-production-scada',
  imports: [Shared],
  templateUrl: './project-tsa-production-scada.component.html',
  styleUrl: './project-tsa-production-scada.component.scss'
})
export class ProjectTsaProductionScadaComponent {
