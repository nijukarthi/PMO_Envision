...
@Component({
  selector: 'app-project-site-accessories',
  imports: [Shared],
  templateUrl: './project-site-accessories.component.html',
  styleUrl: './project-site-accessories.component.scss'
})
export class ProjectSiteAccessoriesComponent {
