...
@Component({
  selector: 'app-project-tsa-delivery-hub',
  imports: [Shared],
  templateUrl: './project-tsa-delivery-hub.component.html',
  styleUrl: './project-tsa-delivery-hub.component.scss'
})
export class ProjectTsaDeliveryHubComponent {
