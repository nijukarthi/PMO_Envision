...
@Component({
  selector: 'app-project-tsa-delivery-scada',
  imports: [Shared],
  templateUrl: './project-tsa-delivery-scada.component.html',
  styleUrl: './project-tsa-delivery-scada.component.scss'
})
export class ProjectTsaDeliveryScadaComponent {
