...
@Component({
  selector: 'app-project-tsa-delivery-blade',
  imports: [Shared],
  templateUrl: './project-tsa-delivery-blade.component.html',
  styleUrl: './project-tsa-delivery-blade.component.scss'
})
export class ProjectTsaDeliveryBladeComponent {
