...
@Component({
  selector: 'app-project-tsa-delivery-tower',
  imports: [Shared],
  templateUrl: './project-tsa-delivery-tower.component.html',
  styleUrl: './project-tsa-delivery-tower.component.scss'
})
export class ProjectTsaDeliveryTowerComponent {
