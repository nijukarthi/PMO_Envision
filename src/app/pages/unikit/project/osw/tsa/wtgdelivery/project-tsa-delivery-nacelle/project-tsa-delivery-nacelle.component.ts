...
@Component({
  selector: 'app-project-tsa-delivery-nacelle',
  imports: [Shared],
  templateUrl: './project-tsa-delivery-nacelle.component.html',
  styleUrl: './project-tsa-delivery-nacelle.component.scss'
})
export class ProjectTsaDeliveryNacelleComponent {
