...
@Component({
  selector: 'app-project-tsa-delivery-site-accessories',
  imports: [Shared],
  templateUrl: './project-tsa-delivery-site-accessories.component.html',
  styleUrl: './project-tsa-delivery-site-accessories.component.scss'
})
export class ProjectTsaDeliverySiteAccessoriesComponent {
