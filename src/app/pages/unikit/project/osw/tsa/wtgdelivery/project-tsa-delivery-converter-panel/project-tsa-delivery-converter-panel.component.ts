...
@Component({
  selector: 'app-project-tsa-delivery-converter-panel',
  imports: [Shared],
  templateUrl: './project-tsa-delivery-converter-panel.component.html',
  styleUrl: './project-tsa-delivery-converter-panel.component.scss'
})
export class ProjectTsaDeliveryConverterPanelComponent {
