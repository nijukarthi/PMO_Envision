...
@Component({
  selector: 'app-project-tsa-delivery-anchorcage',
  imports: [Shared],
  templateUrl: './project-tsa-delivery-anchorcage.component.html',
  styleUrl: './project-tsa-delivery-anchorcage.component.scss'
})
export class ProjectTsaDeliveryAnchorcageComponent {
